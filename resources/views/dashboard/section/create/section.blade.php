    ...
    <div class="card mx-auto" style="max-width: 900px;">
        ...
        <div class="card-body px-4 py-2">
            <form>
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <label for="akun-dikreditkan" class="form-label">Periode Penggunaan</label>
                        <div class="mb-3">
                            <input type="text" class="form-control" id="Periode Penggunaan" placeholder="Periode Penggunaan">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
