...
<head>
  ...
  <link rel="stylesheet" crossorigin href="/css/iconly.css">
</head>
            ...
            <li
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button form="logout" href="{{route('logout')}}" onclick="event.preventDefault();
                                        this.closest('form').submit();" class='d-flex justify-content-center align-items-center rounded border-0 bg-danger cursor-pointer' style="width: 90%; height: 40px; color: #fff">
                        <i class=""></i>
                        <span>Logout</span>
                    </button>
                </form>
...
<div class="page-content"> 
    ...
    <script src="SagaraMobile/resources/js/app.js"></script>
</body>
